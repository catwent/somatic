    ...
    .then((permissionState) => {
      ...
      if (permissionState === "granted") {
        ...
        window.addEventListener("deviceorientation", (event) => {
          ...
          // AND TEMPORARY INDICES FOR GEOLOCATION, NOW USING ORINETATION BUT LATER TO USE LOCATION
          ...
          var alphaPhrase = alphaPhraseArray[alphaIndex];
          var betaPhrase = betaPhraseArray[betaIndex];
          var gammaPhrase = gammaPhraseArray[gammaIndex];
          console.log(betaPhrase);
          // AND TEMPORARY PHRASES FOR GEOLOCATION, NOW USING ORINETATION BUT LATER TO USE LOCATION
          var geo1Phrase = geo1PhraseArray[geo1Index];
          var geo2Phrase = geo2PhraseArray[geo2Index];
          var geo3Phrase = geo3PhraseArray[geo3Index];
...
if ("geolocation" in navigator) {
  ...
  const handleLocation = (position) => {
    ...
    if (arePointsNear(currentLocation, centerPoint, 10)) {
      console.log("Location is outside 10 meters of center");
    }
  };
...
function arePointsNear(checkPoint, centerPoint, m) {
  ...
  console.log(Math.sqrt(dx * dx + dy * dy) * 1000);
